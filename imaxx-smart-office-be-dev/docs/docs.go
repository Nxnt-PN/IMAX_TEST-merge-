...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/leave-forms": {
            "get": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "description": "sort sql string ex. created_at desc",
                        "name": "sort",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "keyword search(state_detail)",
                        "name": "keyword",
                        "in": "query"
                    },
                    {
                    ...
                    },
                    {
                        ...
                        "type": "integer",
                        "description": "State (1=Draft, 2=Waiting, 3=Complete, 4=Rejected)",
                        "name": "state",
                        "in": "query"
                    }
                ],
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "create leave form payload",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.LeaveFormRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/leave-forms/cancel/{id}": {
            "put": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "LeaveForm ID (uuid)",
                        "name": "id",
                        "in": "path",
                        "required": true
                    },
                    {
                        "description": "cancel leave form and put remark",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/leave-forms/review/{id}": {
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "review the leaveform approve and remark",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/leave-forms/task": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "leave form task uuids",
                        "name": "ids",
                        "in": "query"
                    }
                ],
        ...
        "/leave-forms/upload/{id}": {
            "patch": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "file",
                        "description": "upload leave form file",
                        "name": "file",
                        "in": "formData",
                        "required": true
                    }
        ...
        "/leave-forms/{id}": {
            ...
            "put": {
                ...
                "parameters": [
                    {
                        "description": "update leaveForm payload",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/leave-quotas": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "create leaveQuota payload",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.CreateLeaveQuotaRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/leave-quotas/{id}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "LeaveQuota ID (uuid)",
                        "name": "id",
                        "in": "path",
                        "required": true
                    }
            ...
            "put": {
                ...
                "parameters": [
                    {
                        "description": "update leaveQuota payload",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.UpdateLeaveQuotaRequest"
                        }
                    },
                    {
                        "type": "string",
            ...
            "get": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        "type": "integer",
                        "default": 1000,
                        "description": "limit per page number(default 1000)",
                        "name": "limit",
                        "in": "query"
                    },
                    {
        ...
        "/systems/{id}": {
            ...
            "put": {
                ...
                "parameters": [
                    {
                        "description": "update system payload",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.UpdateSystemRequest"
                        }
                    },
                    {
                        "type": "string",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.AuthenticateRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/controller.EditPassword"
                        }
                    }
                ],
                "responses": {
        ...
        "/workflows": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "create workflow payload",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.CreateWorkflowRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/workflows/{id}": {
            ...
            "put": {
                ...
                "parameters": [
                    {
                        "description": "update workflow payload",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.UpdateWorkflowRequest"
                        }
                    },
                    {
                        "type": "string",
    ...
    "definitions": {
        ...
        "request.CreateLeaveQuotaDetailRequest": {
            "type": "object",
            "required": [
                "absence_quota",
                "annual_quota",
        ...
        "request.CreateLeaveQuotaRequest": {
            "type": "object",
            "required": [
                "leave_quota_details",
                "status",
            ...
            "properties": {
                "leave_quota_details": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/request.CreateLeaveQuotaDetailRequest"
                    }
                },
                "status": {
                    "type": "integer",
        ...
        "request.CreateWorkflowDetailRequest": {
            "type": "object",
            "required": [
                "is_final",
                "name",
        ...
        "request.CreateWorkflowRequest": {
            ...
            "properties": {
                ...
                "workflow_details": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/request.CreateWorkflowDetailRequest"
                    }
                }
            }
        },
        "request.LeaveFormRequest": {
            "type": "object",
            "required": [
                "action",
                "end_date",
            ...
            "properties": {
                "action": {
                    ...
                    "allOf": [
                        {
                            "$ref": "#/definitions/enums.ActionRequest"
                        }
                    ]
                },
                "end_date": {
                ...
                "leave_type": {
                    "$ref": "#/definitions/enums.LeaveType"
                },
                "reason": {
                    "type": "string"
                },
        ...
        "request.UpdateLeaveQuotaDetailRequest": {
            "type": "object",
            "required": [
                "absence_quota",
                "annual_quota",
        ...
        "request.UpdateLeaveQuotaRequest": {
            "type": "object",
            "required": [
                "leave_quota_details",
                "status",
            ...
            "properties": {
                "leave_quota_details": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/request.UpdateLeaveQuotaDetailRequest"
                    }
                },
                "status": {
                    "type": "integer",
        ...
        "request.UpdateWorkflowDetailRequest": {
            "type": "object",
            "required": [
                "is_final",
                "name",
        ...
        "request.UpdateWorkflowRequest": {
            ...
            "properties": {
                ...
                "workflow_details": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/request.UpdateWorkflowDetailRequest"
                    }
                }
            }
        },
